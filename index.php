  ...
  <div class="collapse navbar-collapse" id="myNavbar">
    ...
    <div class="collapse navbar-collapse" id="myNavbar">
      <ul class="nav navbar-nav navbar-right">
        ...
        <li><a href="http://localhost/jobagg/login.php">Projects</a></li>
        <li><a href="#team">Contact</a></li>
        <li>
        <p class="w3-large">
          <a href= "http://localhost/jobagg/login.php">
            <button class="w3-button w3-round w3-orange w3-opacity w3-hover-opacity-off" style="padding:8px 60px">Login</button>
          </a>
        </p>
      </li> 
      </ul>
...
<div class="w3-container w3-light-grey" style="padding:128px 16px" id="exp">
  ...
  <div class="w3-row-padding w3-center" style="margin-top:64px;">
    <div class="col-sm-12 w3-margin-center">
      <div class="w3-card">
      <h3>Please Login !!!</h3>
   </div>
  </div>
...
<footer class="w3-center w3-black w3-padding-64" id="i">
  ...
  <!-- <p>Powered by <a href="http://www.eternalhr.com/" title="W3.CSS" target="_blank" class="w3-hover-text-green">cmds solutions</a></p> -->
</footer>
